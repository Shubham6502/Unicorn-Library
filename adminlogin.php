    ...
    <div class="main">
        ...
        <div class="bookseat">
            ...
            <form action="adminlogincode.php" method="POST">
                ...
                <div class="seatno"><label for="">Password</label></div>
                <div class="txt"><input type="password" name="password" required="required"></div>
        ...
        <div class="foot">
        @All Copyright Reserved By Shubham Patil & Shubham Gavade
        </div>
    </div>
