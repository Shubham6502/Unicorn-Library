...
<body>
    ...
    <div class="main">
        ...
        <div class="bookseat">
            ...
            <form action="addfeecode.php" method="POST">
                ...
                <div class="seatno"><label for="">Amount</label></div>
                <div class="txt"><input type="text" name="fee" required="required"></div>
                ...
                <div class="seatno"><label for="">Remark</label></div>
                <div class="txt"><input type="text" name="remark" ></div>
        ...
        <div class="heading">
    <a href="month_history.php"  style="color:green">View Monthly history</a>
</div>
